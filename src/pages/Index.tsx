  ...
  const internships = [
    {
      ...
      description: "Artificial & Machine Learning Intern at InLighnX Global Pvt Ltd, where I learned about CNNs and a made a Nueral Network for learning upon the given dataset.",
