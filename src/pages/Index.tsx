...
import { Mail, Github, Linkedin, ExternalLink, ChevronDown, Award, Briefcase, Code2, Download, BrainCircuit, Workflow, Menu, Codepen, X,Atom } from 'lucide-react';
  ...
  const internships = [
    {
      ...
      description: "Artificial & Machine Learning Intern at InLighnX Global Pvt Ltd, where I learned about CNNs a develop a decisive Neural Network with TensorFlow helping the system to work efficiently.",
    ...
    >
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="bg-slate-800 border-slate-700 max-w-lg">
                          ...
                          <div className="mt-4 flex justify-center">
                            <button
                              onClick={() => setFullScreenImage(internship.certificate!.url)}
            ...
            {filteredCertifications.map((cert, index) => (
              <Dialog key={index}>
                ...
                <DialogContent className="bg-slate-800 border-slate-700 max-w-lg">
                  ...
                  <div className="mt-4 flex justify-center">
                    <button
                      onClick={() => setFullScreenImage(cert.imagePath)}
                      className="cursor-pointer"
                    >
                      <img
                        src={cert.imagePath}
      ...
      <section id="projects" className="py-20">
        <div className="container mx-auto px-6">
          ...
          {/* Filter Buttons */}
          <div className="flex justify-center gap-4 mb-8">
            {['All', 'Web Development', 'Machine Learning'].map((filter) => (
              <Button
                key={filter}
